        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-bold">Edit Chipset</h3>

                    <!-- Update Form -->
                    <form action="{{ route('component-chipset-types.update', $chipset->component_chipset_id) }}" method="POST">
                        @csrf
                        ...
                        <div class="mt-4">
                            ...
                            <input type="text" name="component_chipset_name" value="{{ old('component_chipset_name', $chipset->component_chipset_name) }}"
